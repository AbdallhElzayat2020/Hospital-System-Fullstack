							...
							<li class="">
								<div class="dropdown nav-itemd-none d-md-flex">
									<a href="#" class="pl-0 d-flex nav-item nav-link country-flag1" data-toggle="dropdown" aria-expanded="false">
										<span class="mr-0 bg-transparent avatar country-Flag align-self-center"><img src="{{URL::asset('Dashboard/img/flags/us_flag.jpg')}}" alt="img"></span>
										<div class="my-auto">
											<strong class="my-auto mr-2 ml-2">English</strong>
										</div>
									</a>
									<div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
										<a href="#" class="dropdown-item d-flex">
											<span class="ml-3 bg-transparent avatar align-self-center"><img src="{{URL::asset('Dashboard/img/flags/french_flag.jpg')}}" alt="img"></span>
											<div class="d-flex">
												<span class="mt-2">French</span>
											</div>
										</a>
										<a href="#" class="dropdown-item d-flex">
											<span class="ml-3 bg-transparent avatar align-self-center"><img src="{{URL::asset('Dashboard/img/flags/germany_flag.jpg')}}" alt="img"></span>
											<div class="d-flex">
												<span class="mt-2">Germany</span>
											</div>
										</a>
										<a href="#" class="dropdown-item d-flex">
											<span class="ml-3 bg-transparent avatar align-self-center"><img src="{{URL::asset('Dashboard/img/flags/italy_flag.jpg')}}" alt="img"></span>
											<div class="d-flex">
												<span class="mt-2">Italy</span>
											</div>
										</a>
										<a href="#" class="dropdown-item d-flex">
											<span class="ml-3 bg-transparent avatar align-self-center"><img src="{{URL::asset('Dashboard/img/flags/russia_flag.jpg')}}" alt="img"></span>
											<div class="d-flex">
												<span class="mt-2">Russia</span>
											</div>
										</a>
										<a href="#" class="dropdown-item d-flex">
											<span class="ml-3 bg-transparent avatar align-self-center"><img src="{{URL::asset('Dashboard/img/flags/spain_flag.jpg')}}" alt="img"></span>
											<div class="d-flex">
									...
									<div class="main-message-list chat-scroll">
										...
										<a href="#" class="p-3 d-flex border-bottom">
											...
											<div class="wd-90p">
												...
												<p class="float-right mt-2 mr-2 mb-0 text-left time">Mar 06 01:12 AM</p>
											</div>
										</a>
										<a href="#" class="p-3 d-flex border-bottom">
											...
											<div class="wd-90p">
												...
												<p class="float-right mt-2 mr-2 mb-0 text-left time">Feb 25 10:35 AM</p>
											</div>
										</a>
										<a href="#" class="p-3 d-flex border-bottom">
											...
											<div class="wd-90p">
												...
												<p class="float-right mt-2 mr-2 mb-0 text-left time">Feb 12 05:12 PM</p>
											</div>
										</a>
										<a href="#" class="p-3 d-flex border-bottom">
											...
											<div class="wd-90p">
												...
												<p class="float-right mt-2 mr-2 mb-0 text-left time">Jan 29 03:16 PM</p>
											</div>
										</a>
									</div>
