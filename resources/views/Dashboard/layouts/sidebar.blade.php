<!-- Sidebar-right-->
		<div class="sidebar sidebar-left sidebar-animate">
			<div class="mb-0 panel panel-primary card box-shadow">
				<div class="p-3 border-0 tab-menu-heading">
					<div class="mb-0 card-title">Notifications</div>
					<div class="mr-auto card-options">
				...
				<div class="p-0 border-0 panel-body tabs-menu-body latest-tasks">
					<div class="tabs-menu">
						...
						<ul class="nav panel-tabs">
							<li class=""><a href="#side1" class="active" data-toggle="tab"><i class="ml-2 ion ion-md-chatboxes tx-18"></i> Chat</a></li>
							<li><a href="#side2" data-toggle="tab"><i class="ml-2 ion ion-md-notifications tx-18"></i> Notifications</a></li>
							<li><a href="#side3" data-toggle="tab"><i class="ml-2 ion ion-md-contacts tx-18"></i> Friends</a></li>
						</ul>
					</div>
					<div class="tab-content">
						<div class="tab-pane active" id="side1">
							<div class="p-3 list d-flex align-items-center border-bottom">
								...
								<a class="mr-3 wrapper w-100" href="#" >
									<p class="mb-0 d-flex">
										<b>New Websites is Created</b>
									</p>
									<div class="d-flex justify-content-between align-items-center">
										<div class="d-flex align-items-center">
											<i class="ml-1 mdi mdi-clock text-muted"></i>
											<small class="ml-auto text-muted">30 mins ago</small>
											<p class="mb-0"></p>
										</div>
									</div>
								</a>
							...
							<div class="p-3 list d-flex align-items-center border-bottom">
								...
								<a class="mr-3 wrapper w-100" href="#" >
									...
									<div class="d-flex justify-content-between align-items-center">
										<div class="d-flex align-items-center">
											<i class="ml-1 mdi mdi-clock text-muted"></i>
											<small class="ml-auto text-muted">2 hours ago</small>
											<p class="mb-0"></p>
										</div>
									</div>
								</a>
							...
							<div class="p-3 list d-flex align-items-center border-bottom">
								...
								<a class="mr-3 wrapper w-100" href="#" >
									...
									<div class="d-flex justify-content-between align-items-center">
										<div class="d-flex align-items-center">
											<i class="ml-1 mdi mdi-clock text-muted"></i>
											<small class="ml-auto text-muted">3 hours ago</small>
											<p class="mb-0"></p>
										</div>
									</div>
								</a>
							...
							<div class="p-3 list d-flex align-items-center border-bottom">
								...
								<a class="mr-3 wrapper w-100" href="#" >
									...
									<div class="d-flex justify-content-between align-items-center">
										<div class="d-flex align-items-center">
											<i class="ml-1 mdi mdi-clock text-muted"></i>
											<small class="ml-auto text-muted">4 hours ago</small>
											<p class="mb-0"></p>
										</div>
									</div>
								</a>
							...
							<div class="p-3 list d-flex align-items-center border-bottom">
								...
								<a class="mr-3 wrapper w-100" href="#" >
									...
									<div class="d-flex justify-content-between align-items-center">
										<div class="d-flex align-items-center">
											<i class="ml-1 mdi mdi-clock text-muted"></i>
											<small class="ml-auto text-muted">1 days ago</small>
											<p class="mb-0"></p>
										</div>
									</div>
								</a>
							...
							<div class="p-3 list d-flex align-items-center border-bottom">
								...
								<a class="mr-3 wrapper w-100" href="#" >
									...
									<div class="d-flex justify-content-between align-items-center">
										<div class="d-flex align-items-center">
											<i class="ml-1 mdi mdi-clock text-muted"></i>
											<small class="ml-auto text-muted">45 mintues ago</small>
											<p class="mb-0"></p>
										</div>
									</div>
								</a>
							...
							<div class="p-3 list d-flex align-items-center">
								...
								<a class="mr-3 wrapper w-100" href="#" >
									...
									<div class="d-flex justify-content-between align-items-center">
										<div class="d-flex align-items-center">
											<i class="ml-1 mdi mdi-clock text-muted"></i>
											<small class="ml-auto text-muted">2 days ago</small>
											<p class="mb-0"></p>
										</div>
									</div>
								</a>
