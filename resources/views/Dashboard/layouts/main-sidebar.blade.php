        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item"
                           href="{{ url('/' . ($page = 'chart-flot')) }}">{{__('Dashboard/doctors.doctors')}}</a>
                    </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}">
                    ...
                    <span class="side-menu__label">{{__('Dashboard/doctors.doctors')}}</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item"
                           href="{{route('doctors.index') }}">{{__('Dashboard/doctors.AllDoctors')}}
                        </a>
                    </li>
