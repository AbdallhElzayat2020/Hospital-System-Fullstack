        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('dashboard.admin') }}">
                    ...
                    <span class="side-menu__label">{{ trans('Dashboard/main-sidebar_trans.index') }}</a>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}">
                    ...
                    <span class="side-menu__label">{{ trans('Dashboard/main-sidebar_trans.sections') }}</span><i
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item"
                           href="{{ url('/' . ($page = 'chart-flot')) }}">{{__('Dashboard/main-sidebar_trans.Doctors')}}</a>
                    </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}">
                    ...
                    <span class="side-menu__label">{{__('Dashboard/main-sidebar_trans.Doctors')}}</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item"
                           href="{{route('doctors.index') }}">{{__('Dashboard/main-sidebar_trans.AllDoctors')}}
                        </a>
                    </li>
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . ($page = 'widgets')) }}">
                    ...
                    <span class="side-menu__label">Widgets</span><span
